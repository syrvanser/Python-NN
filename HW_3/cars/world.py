...
class SimpleCarWorld(World):
    COLLISION_PENALTY = 20 # выберите сами
    HEADING_REWARD =  10 # выберите сами
    WRONG_HEADING_PENALTY = -10 # выберите сами
    IDLENESS_PENALTY = 5 # выберите сами
    SPEEDING_PENALTY = 5 # выберите сами
    MIN_SPEED = 0 # выберите сами
